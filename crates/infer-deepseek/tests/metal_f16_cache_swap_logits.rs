...
#[test]
#[ignore]
fn metal_f16_cache_swap_logits() -> Result<()> {
    ...
    let mut cache_f32_for_f16 = cache_f32.clone();
    let out_f16_with_f32_cache = model_f16.forward(
        None,
        Some(&embed_f16),
        None,
        None,
    ...
    let logits_f16_f32cache = out_f16_with_f32_cache.logits.get(0)?.get(0)?;
    ...
    let (t1, v1, t2, v2) = top2_logits(&logits_f16_f32cache)?;
    println!(
    ...
    println!(
        "f32 cache: top1 {t1} {v1} top2 {t2} {v2} margin {}",
        v1 - v2
    );
